...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Create Supervisor'])
    <div class="row mt-4 mx-4">
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-start justify-content-between pb-0">
                    <h6>Create Supervisor</h6>
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="container">
                        ...
                        <form action="{{ route('management-supervisor.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    <input type="text" name="user_position" class="form-control" placeholder="Employee Position" aria-label="Employee Position" name="{{ old('user_position') }}" required>
                                </div>
                                <div class="col-6">
                            ...
                            <div class="mb-3">
                                <input type="text" name="country_phone_code" class="form-control" placeholder="Country Phone Code (+62, etc)"
                                    aria-label="Country Code" value="{{ old('country_phone_code') }}" required>
                            </div>
                            <div class="mb-3">
